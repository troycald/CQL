...
public class CompletionProver<Ty, En, Sym, Fk, Att, Gen, Sk>
	...
	private final LPOUKB<Chc<Ty, En>, Head<Ty, En, Sym, Fk, Att, Gen, Sk>, String> cp;

	public CompletionProver(AqlOptions ops, KBTheory<Chc<Ty, En>, Head<Ty, En, Sym, Fk, Att, Gen, Sk>, String> xx,
		...
		Iterable<Triple<KBExp<Head<Ty, En, Sym, Fk, Att, Gen, Sk>, String>, KBExp<Head<Ty, En, Sym, Fk, Att, Gen, Sk>, String>, Map<String, Chc<Ty, En>>>> E0 = Iterables
	...
	@Override
	public boolean eq(Map<String, Chc<Ty, En>> ctx, KBExp<Head<Ty, En, Sym, Fk, Att, Gen, Sk>, String> lhs,

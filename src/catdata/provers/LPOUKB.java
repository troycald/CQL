...
//    vars.addAll(rhs.vars());
	...
	Collection<Triple<KBExp<C, V>, KBExp<C, V>, Map<V, T>>> E0;
...
/* 			var newkb = new KBTheory<>(this.kb);
			var newprec = new LinkedList<>(prec);
			
			var ret = new LPOUKB<>(E0, fresh, R0, options, newprec, newkb);
			*/

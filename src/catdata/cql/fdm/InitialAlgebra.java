...
import catdata.cql.exp.IgnoreException;
...
public final class InitialAlgebra<Ty, En, Sym, Fk, Att, Gen, Sk>
	...
	public synchronized Object printX(En en, Integer x) {
		return repr(en, x).toString(Util.voidFn(), z -> printGen.apply(z).toString(), false);
	}
	...
	public InitialAlgebra(AqlOptions ops, Schema<Ty, En, Sym, Fk, Att> schema, Collage<Ty, En, Sym, Fk, Att, Gen, Sk> o,
			Function<Gen, Object> printGen, BiFunction<Ty, Sk, Object> printSk, DP<Ty, En, Sym, Fk, Att, Gen, Sk> dp, ProverName p) {
		// col.validate();
		this.schema = schema;
	...
	//	boolean warn = (boolean) ops.getOrDefault(AqlOption.diverge_warn);
		...
		this.dp_en = (DP<Void, En, Void, Fk, Void, Gen, Void>) (Object) dp;

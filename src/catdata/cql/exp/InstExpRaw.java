...
import catdata.cql.NoAlgInstance;
...
public final class InstExpRaw extends InstExp<String, String, Integer, Chc<String, Pair<Integer, Att>>> implements Raw {
	...
	@SuppressWarnings("unchecked")
	@Override
	public synchronized Instance<String, String, Sym, Fk, Att, String, String, Integer, Chc<String, Pair<Integer, Att>>> eval0(
		...
		InitialAlgebra<String, String, Sym, Fk, Att, String, String> initial = new InitialAlgebra<>(strat, sch, col,
				(y) -> y, (x, y) -> y);
	...
	private static Instance<String, String, Sym, Fk, Att, String, String, Integer, Chc<String, Pair<Integer, Att>>> eval0_algebra(
			...
			Set<Pair<Term<String, String, Sym, Fk, Att, String, String>, Term<String, String, Sym, Fk, Att, String, String>>> eqs0,
			AqlOptions strat, boolean dont_check_closure) {
		@SuppressWarnings({ "unchecked" })
		...
		ImportAlgebra alg = new ImportAlgebra<>(sch, x -> ens0.get(x), tys0, (en, x) -> fks0x.get(en).get(x),
				(en, x) -> atts0x.get(en).get(x), (x, y) -> y, (x, y) -> y, dont_check_closure, Collections.emptySet());
//Instance<String, String, Sym, Fk, Att, String, String, Integer, Chc<String, Pair<Integer, Att>>>
	...
	private static Term<String, Void, Sym, Void, Void, Void, Null<?>> objectToSk(
			Schema<String, String, Sym, Fk, Att> sch, Object rhs, String x, Att att,
			Map<String, Collection<Null<?>>> sks,
			Map<Null<?>, Term<String, String, Sym, Fk, Att, String, Null<?>>> extraRepr, boolean shouldJS,
			boolean errMeansNull) {

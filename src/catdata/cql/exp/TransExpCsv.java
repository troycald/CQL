...
public class TransExpCsv<X1, Y1, X2, Y2>
	...
	public TransExpCsv(InstExp<String, String, X1, Y1> src, InstExp<String, String, X2, Y2> dst,
			List<Pair<LocStr, String>> files, List<Pair<String, String>> options) {
	...
	@Override
	protected void processEn(String en, Schema<String, String, Sym, Fk, Att> sch, Map<String, List<String[]>> h,
	...
	protected Map<String, List<String[]>> start(Schema<String, String, Sym, Fk, Att> sch) throws Exception {
		...
		Map<String, List<String[]>> ret = InstExpCsv.start2(map2, op, sch.collage(), false, this.map);
		return ret; */
		throw new RuntimeException("Transform import deprecated.");
	}
